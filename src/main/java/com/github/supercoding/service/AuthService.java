...
public class AuthService {
    ...
    public boolean signUp(SignUp signUpRequest) {
        ...
        Roles roles = rolesRepository.findByName("ROLE_USER").orElseThrow(() -> new NotFoundException("ROLE_USER 를 찾을 수 없습니다"));
    ...
    public String login(Login loginRequest) {
        ...
        try{
            ...
            UserPrincipal userPrincipal = userPrincipalRepository.findByEmailFetchJoin(email)
                    .orElseThrow(() -> new NotFoundException("UserPrincipal not found"));
